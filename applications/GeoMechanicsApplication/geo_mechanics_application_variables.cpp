...
KRATOS_CREATE_VARIABLE(std::size_t, GEO_MAX_PLASTIC_ITERATIONS)
KRATOS_CREATE_VARIABLE(double, GEO_ABS_YIELD_FUNCTION_TOLERANCE)
KRATOS_CREATE_VARIABLE(double, GEO_COMPRESSION_CAP_SIZE)
KRATOS_CREATE_VARIABLE(double, GEO_PRECONSOLIDATION_STRESS)
KRATOS_CREATE_VARIABLE(std::string, GEO_CAP_HARDENING_TYPE)
...
KRATOS_CREATE_VARIABLE(Vector, GEO_RELATIVE_DISPLACEMENT_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, GEO_EFFECTIVE_TRACTION_VECTOR)
...
KRATOS_CREATE_VARIABLE(bool, SKIP_INTERNAL_FORCES)
...
KRATOS_CREATE_VARIABLE(int, GEO_PLASTICITY_STATUS)

KRATOS_CREATE_VARIABLE(int, INACCURATE_PLASTIC_POINTS)
KRATOS_CREATE_VARIABLE(int, N_PLASTIC_POINTS)
