...
from KratosMultiphysics.RailwayApplication.set_nodal_parameters_process import SetNodalParametersProcess
import KratosMultiphysics.KratosUnittest as KratosUnittest


class KratosRailwayAddNodalParametersTests(KratosUnittest.TestCase):

    def test_add_nodal_parameters_process_nodal_concentrated_element(self):
        """
    ...
    def test_add_nodal_parameters_process_spring_damper_element(self):
        """
        This test checks if the SetNodalParametersProcess sets the nodal parameters of the model part containing
